...
function init_invaders_wave_1 (invaders, t)
  ...
  path_init(path_8_2)
  -- invaders
  table.insert(invaders,{id=2,od=0,xd=-4,yd=-4,paths={path_1_1,path_1_2}})
  table.insert(invaders,{id=2,od=0,xd=-4,yd=-4,paths={path_2_1,path_2_2}})
  table.insert(invaders,{id=2,od=0,xd=-4,yd=-4,paths={path_3_1,path_3_2}})
  table.insert(invaders,{id=2,od=0,xd=-4,yd=-4,paths={path_4_1,path_4_2}})
  table.insert(invaders,{id=4,od=0,xd=-4,yd=-4,paths={path_5_1,path_5_2}})
  table.insert(invaders,{id=4,od=0,xd=-4,yd=-4,paths={path_6_1,path_6_2}})
  table.insert(invaders,{id=4,od=0,xd=-4,yd=-4,paths={path_7_1,path_7_2}})
  table.insert(invaders,{id=4,od=0,xd=-4,yd=-4,paths={path_8_1,path_8_2}})
...
function init_mode_demo ()
  ...
  invaders={}
  local t=tick
  t=init_invaders_wave_1(invaders,t+200)
